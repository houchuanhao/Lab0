                             ...
                             SubsecondTime now, CacheCntlr *cntlr)
{
   ...
   UInt32 set_index;
   splitAddress(addr, tag, set_index);
   //printf("addr: %lx,tag:%lx,set_index:%x  m_log_blocksize %x 5555555555555555555 \n", addr, tag, set_index,m_log_blocksize);
